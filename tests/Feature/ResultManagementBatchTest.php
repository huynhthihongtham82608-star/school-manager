...
class ResultManagementBatchTest extends TestCase
{
    ...
    private function attendanceStoreRequest(User $admin, Semester $semester, SchoolClass $class, Carbon $date, string $sessionType, Student $student): Request
    {
        $request = Request::create('/attendance', 'POST', [
            ...
            'status' => [
                $student->getKey() => AttendanceRecord::STATUS_PRESENT,
            ],
            'note' => [
                $student->getKey() => null,
            ],
