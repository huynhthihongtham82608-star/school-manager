                                ...
                                <div class="content-action-group justify-content-end" data-action-synced="true">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end content-action-menu">
                                            ...
                                            <form method="POST" action="{{ route('announcements.destroy', $post) }}" data-confirm-message="Bạn có chắc chắn muốn xóa dữ liệu này? Hành động này không thể hoàn tác!">
                                                @csrf
                                                @method('DELETE')
                                ...
                                <div class="content-action-group justify-content-end" data-action-synced="true">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end content-action-menu">
                                            ...
                                            <form method="POST" action="{{ route('events.destroy', $event) }}" data-confirm-message="Bạn có chắc chắn muốn xóa dữ liệu này? Hành động này không thể hoàn tác!">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="dropdown-item danger">
                                                    <i class="bi bi-trash"></i>Xóa bỏ
