                    ...
                    <td class="text-end">
                        <div class="content-action-group justify-content-end" data-action-synced="true">
                            @if(! $readOnly && $semester->canEdit())
                                <a href="{{ route('semesters.edit', $semester) }}" class="content-action-btn icon-only edit d-none" title="Sửa" aria-label="Sửa" data-bs-toggle="tooltip" aria-hidden="true">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end content-action-menu">
                                    ...
                                    @unless($readOnly)
                                        @if($semester->canEdit())
                                            <li>
                                                <a class="dropdown-item" href="{{ route('semesters.edit', $semester) }}">
