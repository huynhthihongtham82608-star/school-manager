...
<div class="audit-log-page">
    ...
    <form method="GET" action="{{ route('audit-logs.index') }}" class="audit-filter-bar">
        <div class="audit-filter-left">
            ...
            <div class="audit-date-group">
                <input type="date" name="date_from" class="form-control audit-date-input" value="{{ $filters['date_from'] ?? '' }}" aria-label="Từ ngày">
                <input type="date" name="date_to" class="form-control audit-date-input" value="{{ $filters['date_to'] ?? '' }}" aria-label="Đến ngày">
            </div>
        </div>
    ...
    <div class="card audit-log-card">
        <div class="table-responsive audit-table-wrap">
            <table class="table table-hover align-middle audit-log-table w-full table-fixed" data-admin-table-skip>
                <colgroup>
